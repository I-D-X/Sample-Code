...
- This sample code uses a SoapClient component within PHP to establish a connection
  to the MyGate server. Ensure that php_soap is enabled in your PHP settings.
...
RESOLUTION:
  ...
  confirm this from within the MyGate Web console under My Account / Integration 
  details. 
...
RESOLUTION:
  This error indicates that an invalid mode has been submitted.
