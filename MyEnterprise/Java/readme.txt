...
- This sample code uses a number of third party libraries including Axis to establish a connection
  to the MyGate server. These libraries are included in the lib folder of the Sample directory.
